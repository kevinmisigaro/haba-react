...
export default function Requestphone(props) {
    ...
    const saveData = () => {
      ...
      console.log({
        ...
        memberID: props.user.username,
        guarantors: guarantorsRef.current,
      });

      axios
        .post(`${process.env.REACT_APP_API_URL}/ynine/requestloan`, {
          amount: values.amount,
          frequency: values.frequency,
          duration: values.duration,
          memberID: props.user.username,
      ...
      <>
        ...
        >
            ...
            <div className="text-center mb-4">
                <p>
                  Once phone is requested, you will be contacted and <br /> be
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="form-group mb-3">
                  ...
                  <p>
                    Please add a minimum of 2 guarantor member usernames for those who
