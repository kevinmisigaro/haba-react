...
export default function CampusAmbassadors() {
  ...
  return (
    <>
      <InnerNavBar />
      <div className="container-fluid" style={{ paddingTop: "150px", color: 'white', backgroundImage: "linear-gradient(to bottom, #00a49f, white)" }}>
        <div className="container">
        <p>We are looking for Campus Ambassadors</p>
        <br />
        <p>
          If you are a finance fanatics and passionate about using technology to
          drive financial inclusion in young people, then here is your one-time
          opportunity Dar Es Salaam, Dodoma, Arusha
        </p>
        <br />
        <h5>Why Join us?</h5>
        <ul>
        ...
        <ol>
          ...
          <li>
            3. Set up at least 3 haba groups per month, comprising of at least 5
            students per group
          </li>
          <li>
          ...
          <li>
            5. Work with Haba team during strategic planning and share feedback
            regarding on-ground information
          </li>
          <li>
            6. Use your social media and other campus platforms to promote Haba
          </li>
        </ol>
        <br />
        <br />
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group mb-3">
            <label style={{color: 'black'}}>What do you like about working with people?</label>
            <textarea
              className="form-control"
              name="qn1"
              cols="100%"
          ...
          <div className="form-group mb-3">
            <label style={{color: 'black'}}>What do you hate about working with people?</label>
            <textarea
              className="form-control"
              name="qn2"
              cols="100%"
          ...
          <div className="form-group mb-3">
            <label style={{color: 'black'}}>What do you care about as an individual?</label>
            <textarea
              className="form-control"
              name="qn3"
              cols="100%"
          ...
          <div className="form-group mb-3">
            <label style={{color: 'black'}}>What inspires you everyday?</label>
            <textarea
              className="form-control"
              name="qn4"
              cols="100%"
          ...
          <div className="form-group mb-3">
            <label style={{color: 'black'}}>Where would you like to be in the next 5 years?</label>
            <textarea
              className="form-control"
              name="qn5"
              cols="100%"
          ...
          <div className="form-group mb-3">
            <label style={{color: 'black'}}>Any other thing you would like us to know about you?</label>
            <textarea
              className="form-control"
              name="qn7"
              cols="100%"
